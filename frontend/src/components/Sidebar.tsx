...
import { LayoutDashboard, Monitor, ArrowLeftRight, Users, BarChart3, Tag, Warehouse } from 'lucide-react'
...
const links = [
  ...
  { to: '/deposits', icon: Warehouse, label: 'Depósitos', adminOnly: true },
